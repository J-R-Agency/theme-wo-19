...
<section class="fullimg-cta conversation left">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 d-none d-lg-block stretch-left fullimg-cta__bkimg" style="background-image:url('<?php echo $ccta_bkimg['url']; ?>');"></div>
            <div class="col-lg-6 col-md-12 fullimg-cta__content text-center">
