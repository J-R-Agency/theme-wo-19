        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-12 col-md-6 order-md-2 d-flex justify-content-center">
                <div class="stories__circleimg">
                    <img src="<?php echo get_template_directory_uri()?>/assets/img/circle-img.jpg" alt="stories image">
                </div>
            </div>
            <div class="col-sm-12 col-md-6">
                ...
                <a class="wo-btn white-pink" href="#">Hear her story</a>
                <a href="#" class="white-link">see all stories</a>
            </div>
        </div>
    </div>
</section>